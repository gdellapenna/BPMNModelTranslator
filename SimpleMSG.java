...
//Messages
    private static class Message_message1 implements BPMNExecProcessUtils.Message {
...
//[outgoing edge] G1 - G1
    ...
    public void TASK_B_B(BPMNExecProcessUtils.ProcessStatus s) {//Send Task B [B]
        ...
        Message_message1 m = new Message_message1();
        m.v1 = "pippo";
...
//[outgoing edge] G2 - G2
    ...
    public void TASK_C_C(BPMNExecProcessUtils.ProcessStatus s) {//Receive Task C [C]
        ...
        Message_message1 receivedMessage = (Message_message1) BPMNExecProcessUtils.receiveMessage(s, "pipe");
        msg_v1 = receivedMessage.v1;
        BPMNExecProcessUtils.debugOutput(s, "	 ASSIGNING msg_v1 TO %s", receivedMessage.v1);
//[outgoing edge] G2 - G2
...
//[outgoing edge] E - E
    ...
    public void execute() {
        BPMNExecProcessUtils.executeProcess("SimpleMSG", this::init, this::EVENT_S_S);
    }

    public static void main(String[] args) {
        BPMNExecProcessUtils.setExternalTraceFile("SimpleMSG");
        BPMNExecProcessUtils.enableTrueParallel();
        SimpleMSG process = new SimpleMSG();
        process.execute();
    }
}
