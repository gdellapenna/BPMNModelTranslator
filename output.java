...
class prova {
    ...
    public dmn_DecisionTable_0wip7uc_result dmn_DecisionTable_0wip7uc(number abs_a_, string s) {
        ...
        if (contains(abs(a), constRange(3, 5)) && not("1", "2")) {
            return new dmn_DecisionTable_0wip7uc_result(/*done*/true, /*message*/ "ok");
        } else if (abs(a) > 10 && inList(s, "a", "b")) {
            return new dmn_DecisionTable_0wip7uc_result(/*done*/false, /*message*/ "no");
        } else if (abs(a) > 1 && s == "c") {
            return new dmn_DecisionTable_0wip7uc_result(/*done*/false, /*message*/ "ko");
        }
    }
