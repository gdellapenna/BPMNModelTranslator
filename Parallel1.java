...
}public void execute() {BPMNExecProcessUtils.executeProcess("Parallel1",this::init,this::EVENT_StartEvent_1_Start);
}public static void main(String[] args) {
BPMNExecProcessUtils.setExternalTraceFile("Parallel1");BPMNExecProcessUtils.enableTrueParallel();Parallel1 process = new Parallel1();
process.execute();}}
