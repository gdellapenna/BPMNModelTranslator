...
class dmn_dtable_GetLengthDT_arguments{public Object Type;
}
...
class dmn_dtable_DetermineModeDT_arguments{public Object Length;
...
class dmn_dtable_ChooseConsentDT_arguments{public Object Mode;
public Object Weight;
}
...
globalAssert(s,"Gateway_07f90ke");
...
globalAssert(s,"Gateway_0i2yujj");
...
globalAssert(s,"Gateway_0u50uj6");
...
globalAssert(s,"Gateway_1ocbjca");
...
globalAssert(s,"Gateway_1tgxmu2");
...
globalAssert(s,"Activity_1cbdv9z");
...
globalAssert(s,"Activity_1ol43bw");
...
globalAssert(s,"Activity_1nfni4r");
...
globalAssert(s,"Activity_0h04jo2");
...
globalAssert(s,"Activity_0iafefy");
...
globalAssert(s,"Activity_1njskid");
//[outgoing edge] Gateway_07f90ke
...
public void init() {
if (this.pType==null) pType=BPMNExecProcessUtils.inputs.getProperty("pType", null);
BPMNExecProcessUtils.logInput("pType",this.pType);
if (this.pWeight==null) pWeight=BPMNExecProcessUtils.inputs.getProperty("pWeight", null);
...
}public void execute(Object _pType,Object _pWeight) {this.pType=_pType;
this.pWeight=_pWeight;
BPMNExecProcessUtils.executeProcess("Shipment",this::init,this::EVENT_package_received);
}public static void main(String[] args) {
BPMNExecProcessUtils.enableTrueParallel();bpmn_process_Shipment process = new bpmn_process_Shipment();
