...
}public void execute() {BPMNExecProcessUtils.executeProcess("Parallel2",this::init,this::EVENT_StartEvent_1_Start);
}public static void main(String[] args) {
BPMNExecProcessUtils.setExternalTraceFile("Parallel2");BPMNExecProcessUtils.enableTrueParallel();Parallel2 process = new Parallel2();
process.execute();}}
