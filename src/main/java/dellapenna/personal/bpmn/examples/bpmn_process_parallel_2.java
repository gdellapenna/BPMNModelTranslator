...
//parallel join initializers
    ...
    public void execute() {
        BPMNExecProcessUtils.executeProcess("Process_1ai2j0m", this::init, this::EVENT_Start);
    }

    public static void main(String[] args) {
        BPMNExecProcessUtils.enableTrueParallel();
        bpmn_process_parallel_2 process = new bpmn_process_parallel_2();
        process.execute();
    }
}
