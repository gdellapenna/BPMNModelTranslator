...
//FORKS: Activity_0svmpy2,Activity_1otvmx2
        BPMNExecProcessUtils.fork(s, "Parallel2Split", this::TASK_Activity_0svmpy2_InnerParallelTask1, this::TASK_Activity_1otvmx2_InnerParallelTask2);
...
//FORKS: Activity_0veq5io,Activity_0pfa4n5
        BPMNExecProcessUtils.fork(s, "Parallel1Split", this::TASK_Activity_0veq5io_Parallel_Task_2, this::TASK_Activity_0pfa4n5_Parallel_Task_1);
        BPMNExecProcessUtils.stopThread();
    }
...
//parallel join initializers
        BPMNExecProcessUtils.initJoin("Gateway_02100g2", "Activity_0pfa4n5", "Activity_09oefmk", "Gateway_1iv1tvb");
        BPMNExecProcessUtils.initJoin("Gateway_1iv1tvb", "Activity_0svmpy2", "Activity_1otvmx2");
    }
    ...
    public void execute() {
        BPMNExecProcessUtils.executeProcess("Parallel1", this::init, this::EVENT_StartEvent_1_Start);
    }

    public static void main(String[] args) {
        BPMNExecProcessUtils.setExternalTraceFile("Parallel1");
        BPMNExecProcessUtils.enableTrueParallel();
        Parallel1 process = new Parallel1();
        process.execute();
    }
}
