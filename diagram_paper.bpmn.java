...
public String toString() { String result="{"; result+="Length="+this.Length ;
return result+"}";}
}
...
if (BPMNExecTypeUtils.tostring(Type).equals("std")) { return new dmn_dtable_GetLengthDT_result(/*Length*/0.5);} else if (BPMNExecTypeUtils.tostring(Type).equals("large")) { return new dmn_dtable_GetLengthDT_result(/*Length*/1.0);} else if (BPMNExecTypeUtils.tostring(Type).equals("xl")) { return new dmn_dtable_GetLengthDT_result(/*Length*/2.0);} else  { return new dmn_dtable_GetLengthDT_result(/*Length*/-(BPMNExecTypeUtils.tonumber(1.0)));}
}
}/*
 * ****************************** DMN Generated Code *************************
 */
...
public String toString() { String result="{"; result+="Mode="+this.Mode ;
return result+"}";}
}
...
if ((BPMNExecTypeUtils.tonumber(Length)>0.0 && BPMNExecTypeUtils.tonumber(Length)<=1.0) && (BPMNExecTypeUtils.tonumber(Weight)>0.0 && BPMNExecTypeUtils.tonumber(Weight)<=5.0)) { return new dmn_dtable_DetermineModeDT_result(/*Mode*/"car");} else if ((BPMNExecTypeUtils.tonumber(Length)>1.0 && BPMNExecTypeUtils.tonumber(Length)<=2.0) && (BPMNExecTypeUtils.tonumber(Weight)>0.0 && BPMNExecTypeUtils.tonumber(Weight)<=5.0)) { return new dmn_dtable_DetermineModeDT_result(/*Mode*/"truck");} else if ((BPMNExecTypeUtils.tonumber(Weight)>5.0 && BPMNExecTypeUtils.tonumber(Weight)<=10.0)) { return new dmn_dtable_DetermineModeDT_result(/*Mode*/"truck");} else  { return new dmn_dtable_DetermineModeDT_result(/*Mode*/"undef");}
}
}/*
 * ****************************** DMN Generated Code *************************
 */
...
public String toString() { String result="{"; result+="Consent="+this.Consent ;
return result+"}";}
}
...
if (BPMNExecTypeUtils.tostring(Mode).equals("car") && BPMNExecTypeUtils.tonumber(Weight) > BPMNExecTypeUtils.tonumber(6.0)) { return new dmn_dtable_ChooseConsentDT_result(/*Consent*/"owner");} else if (BPMNExecTypeUtils.tostring(Mode).equals("truck") && BPMNExecTypeUtils.tonumber(Weight) > BPMNExecTypeUtils.tonumber(8.0)) { return new dmn_dtable_ChooseConsentDT_result(/*Consent*/"com");} else  { return new dmn_dtable_ChooseConsentDT_result(/*Consent*/"none");}
}
}
...
if (BPMNExecTypeUtils.tonumber(pWeight) > BPMNExecTypeUtils.tonumber(10.0)){EVENT_unsuppoted_weight(s);
} else {TASK_determine_mode(s);
}
}
...
if (sMode.equals("undef")){EVENT_no_shipment(s);
} else {TASK_choose_consent(s);
}
}
...
if (pLength.equals(-(BPMNExecTypeUtils.tonumber(1.0)))){EVENT_undefined_length(s);
} else {TASK_measure_weight(s);
}
}
...
if (consent.equals("com")){TASK_sign_declaration(s);
} else if (consent.equals("owner")){TASK_fetch_declaration(s);
} else if (consent.equals("none")){GATEWAY_Gateway_07f90ke(s);
...
BPMNExecProcessUtils.error("Unsupported Weight", 2);
}
...
BPMNExecProcessUtils.error("Undefined Length", 1);
}
...
BPMNExecProcessUtils.error("No Shipment", 3);
}
...
if (this.input_PackageWeight==null) input_PackageWeight=BPMNExecProcessUtils.inputs.getProperty("input_PackageWeight", null);
if (this.input_PackageType==null) input_PackageType=BPMNExecProcessUtils.inputs.getProperty("input_PackageType", null);
...
BPMNExecProcessUtils.enableTrueParallel();BPMNExecProcessUtils.start();bpmn_process_Shipment process = new bpmn_process_Shipment();
process.init();
process.EVENT_package_received(new BPMNExecProcessUtils.ProcessStatus("Main"));
}}
